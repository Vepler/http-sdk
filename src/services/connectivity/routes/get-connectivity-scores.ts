...
export async function getConnectivityScores(
  params: GetConnectivityScoresParams
): Promise<GetConnectivityScoresResponse> {
  const {
    geographicCodes,
    includeBreakdown,
    includeAreaInfo,
  ...
  if (includeBreakdown !== undefined)
    queryParams.includeBreakdown = includeBreakdown;
  if (includeAreaInfo !== undefined)
    queryParams.includeAreaInfo = includeAreaInfo;
  ...
  if (includePeriodHistory !== undefined)
    queryParams.includePeriodHistory = includePeriodHistory;
